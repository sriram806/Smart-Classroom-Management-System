...
import StudentAttendance from './User/StudentAttendance';
...
import WebcamAttendance from './Teacher/WebcamAttendance';
import StudentSummary from './Teacher/StudentSummary';
import ManualAttendance from './Teacher/ManualAttendance';
import TeacherAttendanceStats from './Teacher/TeacherAttendanceStats';
import CourseAttendanceStats from './Teacher/CourseAttendanceStats';
function Main() {
    return (
        <div className="App">
            <Header />
            <Routes>
                ...
                <Route path='/webcam' element={<WebcamAttendance />} />
                ...
                <Route path='/course-attendance-stats/:course_id' element={<CourseAttendanceStats />} />
            </Routes>
            <Footer />
        </div>
    );
