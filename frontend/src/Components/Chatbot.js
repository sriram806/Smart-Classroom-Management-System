...
function Chatbot() {
    ...
    return (
        <div className="container mt-3 p-2 border rounded" style={{ maxWidth: '600px', backgroundColor: '#f7f9fc' }}>
                ...
                <div className="d-flex flex-column">
                    {messages.map((msg, index) => (
                        <div 
                            ...
                            <div 
                                className={`p-3 rounded ${msg.sender === "user" ? "bg-primary text-white" : "bg-secondary text-white"} message-bubble`} 
                                style={{
                                    maxWidth: '75%', 
                                    wordWrap: 'break-word',
                                    fontSize: '1.1rem',
